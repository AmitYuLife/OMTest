...
This is the **ANCHOR SCREEN**—the most important foundational screen in the 8-screen concept deck.
...
**Design Goal**: Make the member feel secure, informed, and empowered—showing that retirement and risk are natural partners, not separate products.
...
```
Shows retirement + protection combined—one financial picture.
...
Lightly shown—available but not forced.
...
### Component Reuse
✅ Header (same as pensions screen)
✅ Card styling (same borders, shadows, radius)
✅ Typography (Bariol, same scale)
✅ Color palette (OM greens, neutrals, Yu pink)
✅ Spacing (8px grid system)

### New Components
🆕 Quick stats bar (3-column summary)
🆕 Nudge banner (green alert with action)
🆕 Value cards (retirement + protection unified)
🆕 Action tiles grid (2×2 optional actions)
🆕 Activity feed (unified recent activity)
🆕 Bottom navigation (4-item nav bar)
...
|-------------|--------|----------------|
| Retirement balance - "Your future income" | ✅ Complete | Card 1 category label |
| Risk protection - "Your family protection" | ✅ Complete | Card 2 with breakdown |
| Combined into one unified value view | ✅ Complete | Quick stats + cards together |
| Simple, clear language (no jargon) | ✅ Complete | Plain language throughout |
| Behavioral nudge (non-intrusive) | ✅ Complete | Green banner with suggestion |
| Optional action tiles (lightly shown) | ✅ Complete | 2×2 grid below cards |
| Personal financial dashboard feel | ✅ Complete | Greeting + home framing |
| Retirement and risk as natural partners | ✅ Complete | Equal visual weight |
...
✅ Color palette (greens, teal, neutrals)
✅ Spacing (24px sections, 16px cards)
✅ Button styles (white, border, hover states)

### New Patterns Introduced:
- Quick stats bar (3-column summary)
- Greeting + personalization
- Unified value cards (retirement + protection equal)
- Action tiles grid (2×2 optional)
...
### Exit Points:
1. **Retirement Card**: Tap → Full pension details screen (existing)
2. **Protection Card**: Tap → Risk cover details screen
3. **Nudge Banner**: Tap → AI recommendations/insights screen
4. **Action Tiles**: Tap → Respective product/service flows
5. **Activity Feed**: Tap → Full activity/transactions screen
6. **Bottom Nav**: Tap → Other sections (Activity, Insights, Profile)
...
1. **Unified Value View**
   - "Notice retirement and protection have equal visual weight—they're natural partners, not separate products."
   - "Quick stats show total value immediately—R1,025k across everything."

2. **Behavioral Intelligence**
   - "The nudge is gentle and curiosity-driven—'See what you could do'—not 'You must act now!'"
   - "Positive framing throughout: 'Your future income,' 'You're well protected.'"

3. **Optional Actions**
   - "Action tiles are available but not pushy—we show opportunities without sales pressure."
   - "Everything is optional—we respect member autonomy."

4. **Personal Dashboard**
   - "This feels like 'my home'—personalized greeting, progress indicators, recent activity."
   - "Members see themselves in the data, not just product information."

5. **Mobile-First**
   - "Bottom nav makes this feel like a native app—familiar, easy to navigate."
...
3. **Protection Gaps**: Change status to "⚠️ Review needed"
...
- **Insights**: Bottom nav → Insights tab
- **Profile**: Bottom nav → Profile tab
...
└── SCREEN_A_README.md                  [This file - quick start]
```
...
**Let's create the financial home where members feel secure, informed, and empowered.** 🏠💚
